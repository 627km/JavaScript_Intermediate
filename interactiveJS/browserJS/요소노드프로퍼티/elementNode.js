...
// textContent - innerHTML과 비슷하다.
console.log(tag.textContent);  // HTML태그 부분을 제외한 텍스트만 가져온다. 
// tag.textContent = 'new text';  요소안의 내용이 완전히 수정된다. 
// tag.textContent = '<li>new text</li>';  textContent는 특수문자도 텍스트로 인식하기 때문에 <li>new text</li>로 대체가 된다.